...
def search(request: SearchRequest):
    ...
    try:
        ...
        retrieval_k = config.get("search", {}).get("initial_retrieval_k", 60) # Increased to 60 for deeper pool
...
"""
        ...
        # Recommendations (only if critical/high CVEs found — data-driven, not boilerplate)
        has_recommendations = critical_count > 0 or high_count > 0
